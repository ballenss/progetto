    ...
    <body>
       ...
       <nav>
         <ul class="ul_menu">
          ...
          <li class="li_menu"> <strong>Bambino</strong> </li>
       ...
       <article>
          ...
          <section>
              <h2 class="titoli_home"> Shop bambino </h2>
			  <a href="felpa-bambino.html">
...
-->
       ...
       <footer>
           <br/>
           Guess Shop Online |
           <a href="faq.html"class="yellow"> Faq </a> | <a href="contatti.html" class="yellow"> 
		   Contatti </a>  <a href="galleria.html" class="yellow"> Galleria immagini </a><br/>
